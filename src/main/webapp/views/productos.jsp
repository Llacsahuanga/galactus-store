...
<body>
	...
	<div class="flex gap-4 bg-green-600 h-[50px] items-center justify-between">
		...
		<a href="/galactus-store/carrito" class="mr-2 bg-white p-1 rounded text-green-700 font-medium hover:bg-green-700 hover:text-white hover:border hover:border-white">Carrito</a>
		</div>
	</header>
	...
	<main class="p-4">
		<div class="flex w-full justify-center p-4 gap-4 flex-wrap">
			<% if (productos != null && !productos.isEmpty()) { %>
				...
				<div  class="flex bg-gray-200 w-[200px] justify-center flex-col p-4 gap-1 items-center rounded-md border border-gray-300 border-solid hover:border-green-600 cursor-pointer">
						...
						<button class="bg-orange-600 w-full text-white font-medium hover:bg-orange-700 p-1rounded cursor-pointer"onclick="agregarCarrito(<%= producto.getIdProducto() %>)">+ Agregrar Carrito</button>
